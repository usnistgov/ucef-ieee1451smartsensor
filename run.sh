...
cd ~/Downloads/ucef-ieee1451smartsensor/DigitalTwin_deployment
...
cd ~/Downloads/ucef-ieee1451smartsensor/DigitalTwin_deployment
xterm -fg yellow -bg black -l -lf $logs_directory/smart-sensor-${timestamp}.log -T "IEEE1451SmartSensor" -geometry 100x30+0+325 -e "mvn exec:java -P ExecJava,IEEE1451SmartSensor" &
waitUntilJoined IEEE1451SmartSensor 1

cd ~/Downloads/ucef-ieee1451smartsensor/DigitalTwin_deployment
xterm -fg green -bg black -l -lf $logs_directory/tester-${timestamp}.log -T "SmartSensorTester" -geometry 100x30+650+0 -e "mvn exec:java -P ExecJava,SmartSensorTester" &
waitUntilJoined SmartSensorTester 1
