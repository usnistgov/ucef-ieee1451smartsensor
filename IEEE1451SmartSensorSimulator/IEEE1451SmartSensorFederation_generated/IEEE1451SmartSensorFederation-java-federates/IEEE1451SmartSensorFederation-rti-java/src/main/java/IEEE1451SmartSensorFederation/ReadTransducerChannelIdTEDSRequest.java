...
/**
* The ReadTransducerChannelIdTEDSRequest class implements the ReadTransducerChannelIdTEDSRequest interaction in the
* IEEE1451SmartSensorFederation simulation.
*/
public class ReadTransducerChannelIdTEDSRequest extends C2WInteractionRoot {

	private static final Logger logger = LogManager.getLogger(ReadTransducerChannelIdTEDSRequest.class);

	/**
	* Default constructor -- creates an instance of the ReadTransducerChannelIdTEDSRequest interaction
	* class with default parameter values.
	*/
	public ReadTransducerChannelIdTEDSRequest() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the ReadTransducerChannelIdTEDSRequest interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the ReadTransducerChannelIdTEDSRequest
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the ReadTransducerChannelIdTEDSRequest interaction class.
	*/
	public static String get_simple_class_name() { return "ReadTransducerChannelIdTEDSRequest"; }
	...
	* ReadTransducerChannelIdTEDSRequest interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest");
		_classNameClassMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest", ReadTransducerChannelIdTEDSRequest.class);
		
		_datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest", _datamemberNames);
		_allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest", _allDatamemberNames);
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest:  could not initialize:  ";
	protected static void init(RTIambassador rti) {
		...
		while(isNotInitialized) {
			try {
				_handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest");
		...
		_classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest", get_handle());
		_classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest");
		_classHandleSimpleNameMap.put(get_handle(), "ReadTransducerChannelIdTEDSRequest");
		...
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,CheckSum", get_CheckSum_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,Length", get_Length_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,MessageID", get_MessageID_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,MessageType", get_MessageType_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,Priority", get_Priority_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,SequenceNo", get_SequenceNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,SessionNo", get_SessionNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,Status", get_Status_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,channelId", get_channelId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,ncapId", get_ncapId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,timId", get_timId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,timeoutNsecs", get_timeoutNsecs_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest,timeoutSecs", get_timeoutSecs_handle());
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest:  could not publish:  ";

	/**
	* Publishes the ReadTransducerChannelIdTEDSRequest interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest:  could not unpublish:  ";
	/**
	* Unpublishes the ReadTransducerChannelIdTEDSRequest interaction class for a federate.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest:  could not subscribe:  ";
	/**
	* Subscribes a federate to the ReadTransducerChannelIdTEDSRequest interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelIdTEDSRequest:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the ReadTransducerChannelIdTEDSRequest interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	* (that is, the ReadTransducerChannelIdTEDSRequest interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the ReadTransducerChannelIdTEDSRequest interaction class).
	...
	*/
	...
	public String toString() {
		return "ReadTransducerChannelIdTEDSRequest("
	...
	*/
	...
	protected ReadTransducerChannelIdTEDSRequest( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected ReadTransducerChannelIdTEDSRequest( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the ReadTransducerChannelIdTEDSRequest interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerChannelIdTEDSRequest interaction class instance
	*/
	public ReadTransducerChannelIdTEDSRequest( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #ReadTransducerChannelIdTEDSRequest( ReceivedInteraction datamemberMap )}, except this
	* new ReadTransducerChannelIdTEDSRequest interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerChannelIdTEDSRequest interaction class instance
	* @param logicalTime timestamp for this new ReadTransducerChannelIdTEDSRequest interaction class
	* instance
	*/
	public ReadTransducerChannelIdTEDSRequest( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new ReadTransducerChannelIdTEDSRequest interaction class instance that is a duplicate
	* of the instance referred to by ReadTransducerChannelIdTEDSRequest_var.
	*
	* @param ReadTransducerChannelIdTEDSRequest_var ReadTransducerChannelIdTEDSRequest interaction class instance of which
	* this newly created ReadTransducerChannelIdTEDSRequest interaction class instance will be a
	* duplicate
	*/
	public ReadTransducerChannelIdTEDSRequest( ReadTransducerChannelIdTEDSRequest ReadTransducerChannelIdTEDSRequest_var ) {
		super( ReadTransducerChannelIdTEDSRequest_var );
		
		
		set_CheckSum( ReadTransducerChannelIdTEDSRequest_var.get_CheckSum() );
		set_Length( ReadTransducerChannelIdTEDSRequest_var.get_Length() );
		set_MessageID( ReadTransducerChannelIdTEDSRequest_var.get_MessageID() );
		set_MessageType( ReadTransducerChannelIdTEDSRequest_var.get_MessageType() );
		set_Priority( ReadTransducerChannelIdTEDSRequest_var.get_Priority() );
		set_SequenceNo( ReadTransducerChannelIdTEDSRequest_var.get_SequenceNo() );
		set_SessionNo( ReadTransducerChannelIdTEDSRequest_var.get_SessionNo() );
		set_Status( ReadTransducerChannelIdTEDSRequest_var.get_Status() );
		set_channelId( ReadTransducerChannelIdTEDSRequest_var.get_channelId() );
		set_ncapId( ReadTransducerChannelIdTEDSRequest_var.get_ncapId() );
		set_timId( ReadTransducerChannelIdTEDSRequest_var.get_timId() );
		set_timeoutNsecs( ReadTransducerChannelIdTEDSRequest_var.get_timeoutNsecs() );
		set_timeoutSecs( ReadTransducerChannelIdTEDSRequest_var.get_timeoutSecs() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof ReadTransducerChannelIdTEDSRequest ) {
			ReadTransducerChannelIdTEDSRequest data = (ReadTransducerChannelIdTEDSRequest)object;
