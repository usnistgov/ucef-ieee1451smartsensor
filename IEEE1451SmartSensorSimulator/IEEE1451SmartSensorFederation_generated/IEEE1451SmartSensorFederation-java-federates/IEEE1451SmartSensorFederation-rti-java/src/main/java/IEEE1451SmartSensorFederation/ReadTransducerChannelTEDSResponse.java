...
/**
* The ReadTransducerChannelTEDSResponse class implements the ReadTransducerChannelTEDSResponse interaction in the
* IEEE1451SmartSensorFederation simulation.
*/
public class ReadTransducerChannelTEDSResponse extends C2WInteractionRoot {

	private static final Logger logger = LogManager.getLogger(ReadTransducerChannelTEDSResponse.class);

	/**
	* Default constructor -- creates an instance of the ReadTransducerChannelTEDSResponse interaction
	* class with default parameter values.
	*/
	public ReadTransducerChannelTEDSResponse() { }
	...
	private static int _transducerChannelTEDS_handle;
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the "transducerChannelTEDS" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "transducerChannelTEDS" parameter
	*/
	public static int get_transducerChannelTEDS_handle() { return _transducerChannelTEDS_handle; }
	...
	/**
	* Returns the handle (RTI assigned) of the ReadTransducerChannelTEDSResponse interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the ReadTransducerChannelTEDSResponse
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the ReadTransducerChannelTEDSResponse interaction class.
	*/
	public static String get_simple_class_name() { return "ReadTransducerChannelTEDSResponse"; }
	...
	* ReadTransducerChannelTEDSResponse interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse");
		_classNameClassMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse", ReadTransducerChannelTEDSResponse.class);
		
		_datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse", _datamemberNames);
		_allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse", _allDatamemberNames);
		...
		_datamemberNames.add("transducerChannelTEDS");
		...
		_allDatamemberNames.add("transducerChannelTEDS");
		...
		_datamemberTypeMap.put("transducerChannelTEDS", "String");
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse:  could not initialize:  ";
	protected static void init(RTIambassador rti) {
		...
		while(isNotInitialized) {
			try {
				_handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse");
		...
		_classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse", get_handle());
		_classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse");
		_classHandleSimpleNameMap.put(get_handle(), "ReadTransducerChannelTEDSResponse");
		...
		while(isNotInitialized) {
			try {
				...
				_transducerChannelTEDS_handle = rti.getParameterHandle("transducerChannelTEDS", get_handle());
				isNotInitialized = false;
			} catch (FederateNotExecutionMember f) {
				logger.error("{} Federate Not Execution Member", initErrorMessage);
				logger.error(f);
		...
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,CheckSum", get_CheckSum_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,Length", get_Length_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,MessageID", get_MessageID_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,MessageType", get_MessageType_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,Priority", get_Priority_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,SequenceNo", get_SequenceNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,SessionNo", get_SessionNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,Status", get_Status_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,errorCode", get_errorCode_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse,transducerChannelTEDS", get_transducerChannelTEDS_handle());
		...
		_datamemberHandleNameMap.put(get_transducerChannelTEDS_handle(), "transducerChannelTEDS");
		
	}

	private static boolean _isPublished = false;
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse:  could not publish:  ";

	/**
	* Publishes the ReadTransducerChannelTEDSResponse interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse:  could not unpublish:  ";
	/**
	* Unpublishes the ReadTransducerChannelTEDSResponse interaction class for a federate.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse:  could not subscribe:  ";
	/**
	* Subscribes a federate to the ReadTransducerChannelTEDSResponse interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSResponse:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the ReadTransducerChannelTEDSResponse interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	* (that is, the ReadTransducerChannelTEDSResponse interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the ReadTransducerChannelTEDSResponse interaction class).
	...
	*/
	...
	public String toString() {
		return "ReadTransducerChannelTEDSResponse("
			...
			+ "," + "transducerChannelTEDS:" + get_transducerChannelTEDS()
			+ ")";
	}
	...
	private String _transducerChannelTEDS = "";
	...
	*/
	...
	/**
	* Set the value of the "transducerChannelTEDS" parameter to "value" for this parameter.
	*
	* @param value the new value for the "transducerChannelTEDS" parameter
	*/
	public void set_transducerChannelTEDS( String value ) { _transducerChannelTEDS = value; }
	
	/**
	* Returns the value of the "transducerChannelTEDS" parameter of this interaction.
	*
	* @return the value of the "transducerChannelTEDS" parameter
	*/
	public String get_transducerChannelTEDS() { return _transducerChannelTEDS; }
	


	protected ReadTransducerChannelTEDSResponse( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected ReadTransducerChannelTEDSResponse( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the ReadTransducerChannelTEDSResponse interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerChannelTEDSResponse interaction class instance
	*/
	public ReadTransducerChannelTEDSResponse( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #ReadTransducerChannelTEDSResponse( ReceivedInteraction datamemberMap )}, except this
	* new ReadTransducerChannelTEDSResponse interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerChannelTEDSResponse interaction class instance
	* @param logicalTime timestamp for this new ReadTransducerChannelTEDSResponse interaction class
	* instance
	*/
	public ReadTransducerChannelTEDSResponse( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new ReadTransducerChannelTEDSResponse interaction class instance that is a duplicate
	* of the instance referred to by ReadTransducerChannelTEDSResponse_var.
	*
	* @param ReadTransducerChannelTEDSResponse_var ReadTransducerChannelTEDSResponse interaction class instance of which
	* this newly created ReadTransducerChannelTEDSResponse interaction class instance will be a
	* duplicate
	*/
	public ReadTransducerChannelTEDSResponse( ReadTransducerChannelTEDSResponse ReadTransducerChannelTEDSResponse_var ) {
		super( ReadTransducerChannelTEDSResponse_var );
		
		
		set_CheckSum( ReadTransducerChannelTEDSResponse_var.get_CheckSum() );
		set_Length( ReadTransducerChannelTEDSResponse_var.get_Length() );
		set_MessageID( ReadTransducerChannelTEDSResponse_var.get_MessageID() );
		set_MessageType( ReadTransducerChannelTEDSResponse_var.get_MessageType() );
		set_Priority( ReadTransducerChannelTEDSResponse_var.get_Priority() );
		set_SequenceNo( ReadTransducerChannelTEDSResponse_var.get_SequenceNo() );
		set_SessionNo( ReadTransducerChannelTEDSResponse_var.get_SessionNo() );
		set_Status( ReadTransducerChannelTEDSResponse_var.get_Status() );
		set_errorCode( ReadTransducerChannelTEDSResponse_var.get_errorCode() );
		set_transducerChannelTEDS( ReadTransducerChannelTEDSResponse_var.get_transducerChannelTEDS() );
	}
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		else if (  "transducerChannelTEDS".equals( datamemberName )  ) return get_transducerChannelTEDS();
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		else if ( get_transducerChannelTEDS_handle() == datamemberHandle ) return get_transducerChannelTEDS();
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		else if ( param_handle == get_transducerChannelTEDS_handle() ) set_transducerChannelTEDS( val );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		else if (  "transducerChannelTEDS".equals( datamemberName )  ) set_transducerChannelTEDS( val );	
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		else if (  "transducerChannelTEDS".equals( datamemberName )  ) set_transducerChannelTEDS( (String)val );		
		else retval = super.setParameterAux( datamemberName, val );
	...
	protected SuppliedParameters createSuppliedDatamembers() {
		SuppliedParameters datamembers = super.createSuppliedDatamembers();
			...
			datamembers.add( get_transducerChannelTEDS_handle(), get_transducerChannelTEDS().getBytes() );
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof ReadTransducerChannelTEDSResponse ) {
			ReadTransducerChannelTEDSResponse data = (ReadTransducerChannelTEDSResponse)object;
				...
				_transducerChannelTEDS = data._transducerChannelTEDS;
