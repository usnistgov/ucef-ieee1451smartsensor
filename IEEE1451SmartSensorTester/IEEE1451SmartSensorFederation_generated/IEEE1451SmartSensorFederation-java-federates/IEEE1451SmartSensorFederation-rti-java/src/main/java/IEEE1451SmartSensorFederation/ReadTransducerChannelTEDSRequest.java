...
/**
* The ReadTransducerChannelTEDSRequest class implements the ReadTransducerChannelTEDSRequest interaction in the
* IEEE1451SmartSensorFederation simulation.
*/
public class ReadTransducerChannelTEDSRequest extends C2WInteractionRoot {

	private static final Logger logger = LogManager.getLogger(ReadTransducerChannelTEDSRequest.class);

	/**
	* Default constructor -- creates an instance of the ReadTransducerChannelTEDSRequest interaction
	* class with default parameter values.
	*/
	public ReadTransducerChannelTEDSRequest() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the ReadTransducerChannelTEDSRequest interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the ReadTransducerChannelTEDSRequest
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the ReadTransducerChannelTEDSRequest interaction class.
	*/
	public static String get_simple_class_name() { return "ReadTransducerChannelTEDSRequest"; }
	...
	* ReadTransducerChannelTEDSRequest interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest");
		_classNameClassMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest", ReadTransducerChannelTEDSRequest.class);
		
		_datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest", _datamemberNames);
		_allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest", _allDatamemberNames);
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest:  could not initialize:  ";
	protected static void init(RTIambassador rti) {
		...
		while(isNotInitialized) {
			try {
				_handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest");
		...
		_classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest", get_handle());
		_classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest");
		_classHandleSimpleNameMap.put(get_handle(), "ReadTransducerChannelTEDSRequest");
		...
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,CheckSum", get_CheckSum_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,Length", get_Length_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,MessageID", get_MessageID_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,MessageType", get_MessageType_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,Priority", get_Priority_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,SequenceNo", get_SequenceNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,SessionNo", get_SessionNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,Status", get_Status_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,channelId", get_channelId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,ncapId", get_ncapId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,timId", get_timId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,timeoutNsecs", get_timeoutNsecs_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest,timeoutSecs", get_timeoutSecs_handle());
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest:  could not publish:  ";

	/**
	* Publishes the ReadTransducerChannelTEDSRequest interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest:  could not unpublish:  ";
	/**
	* Unpublishes the ReadTransducerChannelTEDSRequest interaction class for a federate.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest:  could not subscribe:  ";
	/**
	* Subscribes a federate to the ReadTransducerChannelTEDSRequest interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerChannelTEDSRequest:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the ReadTransducerChannelTEDSRequest interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	* (that is, the ReadTransducerChannelTEDSRequest interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the ReadTransducerChannelTEDSRequest interaction class).
	...
	*/
	...
	public String toString() {
		return "ReadTransducerChannelTEDSRequest("
	...
	*/
	...
	protected ReadTransducerChannelTEDSRequest( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected ReadTransducerChannelTEDSRequest( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the ReadTransducerChannelTEDSRequest interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerChannelTEDSRequest interaction class instance
	*/
	public ReadTransducerChannelTEDSRequest( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #ReadTransducerChannelTEDSRequest( ReceivedInteraction datamemberMap )}, except this
	* new ReadTransducerChannelTEDSRequest interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerChannelTEDSRequest interaction class instance
	* @param logicalTime timestamp for this new ReadTransducerChannelTEDSRequest interaction class
	* instance
	*/
	public ReadTransducerChannelTEDSRequest( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new ReadTransducerChannelTEDSRequest interaction class instance that is a duplicate
	* of the instance referred to by ReadTransducerChannelTEDSRequest_var.
	*
	* @param ReadTransducerChannelTEDSRequest_var ReadTransducerChannelTEDSRequest interaction class instance of which
	* this newly created ReadTransducerChannelTEDSRequest interaction class instance will be a
	* duplicate
	*/
	public ReadTransducerChannelTEDSRequest( ReadTransducerChannelTEDSRequest ReadTransducerChannelTEDSRequest_var ) {
		super( ReadTransducerChannelTEDSRequest_var );
		
		
		set_CheckSum( ReadTransducerChannelTEDSRequest_var.get_CheckSum() );
		set_Length( ReadTransducerChannelTEDSRequest_var.get_Length() );
		set_MessageID( ReadTransducerChannelTEDSRequest_var.get_MessageID() );
		set_MessageType( ReadTransducerChannelTEDSRequest_var.get_MessageType() );
		set_Priority( ReadTransducerChannelTEDSRequest_var.get_Priority() );
		set_SequenceNo( ReadTransducerChannelTEDSRequest_var.get_SequenceNo() );
		set_SessionNo( ReadTransducerChannelTEDSRequest_var.get_SessionNo() );
		set_Status( ReadTransducerChannelTEDSRequest_var.get_Status() );
		set_channelId( ReadTransducerChannelTEDSRequest_var.get_channelId() );
		set_ncapId( ReadTransducerChannelTEDSRequest_var.get_ncapId() );
		set_timId( ReadTransducerChannelTEDSRequest_var.get_timId() );
		set_timeoutNsecs( ReadTransducerChannelTEDSRequest_var.get_timeoutNsecs() );
		set_timeoutSecs( ReadTransducerChannelTEDSRequest_var.get_timeoutSecs() );
	}
	...
	*/
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof ReadTransducerChannelTEDSRequest ) {
			ReadTransducerChannelTEDSRequest data = (ReadTransducerChannelTEDSRequest)object;
