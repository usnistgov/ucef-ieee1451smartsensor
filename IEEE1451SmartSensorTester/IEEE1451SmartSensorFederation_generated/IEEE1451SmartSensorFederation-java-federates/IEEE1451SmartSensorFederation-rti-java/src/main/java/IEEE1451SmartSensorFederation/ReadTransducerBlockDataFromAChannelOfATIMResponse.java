...
/**
* The ReadTransducerBlockDataFromAChannelOfATIMResponse class implements the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction in the
* IEEE1451SmartSensorFederation simulation.
*/
public class ReadTransducerBlockDataFromAChannelOfATIMResponse extends C2WInteractionRoot {

	private static final Logger logger = LogManager.getLogger(ReadTransducerBlockDataFromAChannelOfATIMResponse.class);

	/**
	* Default constructor -- creates an instance of the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction
	* class with default parameter values.
	*/
	public ReadTransducerBlockDataFromAChannelOfATIMResponse() { }
	...
	private static int _transducerBlockData_handle;
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the "transducerBlockData" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "transducerBlockData" parameter
	*/
	public static int get_transducerBlockData_handle() { return _transducerBlockData_handle; }
	...
	/**
	* Returns the handle (RTI assigned) of the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the ReadTransducerBlockDataFromAChannelOfATIMResponse
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class.
	*/
	public static String get_simple_class_name() { return "ReadTransducerBlockDataFromAChannelOfATIMResponse"; }
	...
	* ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse");
		_classNameClassMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse", ReadTransducerBlockDataFromAChannelOfATIMResponse.class);
		
		_datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse", _datamemberNames);
		_allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse", _allDatamemberNames);
		...
		_datamemberNames.add("transducerBlockData");
		...
		_allDatamemberNames.add("transducerBlockData");
		...
		_datamemberTypeMap.put("transducerBlockData", "String");
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse:  could not initialize:  ";
	protected static void init(RTIambassador rti) {
		...
		while(isNotInitialized) {
			try {
				_handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse");
		...
		_classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse", get_handle());
		_classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse");
		_classHandleSimpleNameMap.put(get_handle(), "ReadTransducerBlockDataFromAChannelOfATIMResponse");
		...
		while(isNotInitialized) {
			try {
				...
				_transducerBlockData_handle = rti.getParameterHandle("transducerBlockData", get_handle());
				isNotInitialized = false;
			} catch (FederateNotExecutionMember f) {
				logger.error("{} Federate Not Execution Member", initErrorMessage);
				logger.error(f);
		...
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,CheckSum", get_CheckSum_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,Length", get_Length_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,MessageID", get_MessageID_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,MessageType", get_MessageType_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,Priority", get_Priority_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,SequenceNo", get_SequenceNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,SessionNo", get_SessionNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,Status", get_Status_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,channelId", get_channelId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,errorCode", get_errorCode_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,ncapId", get_ncapId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,timId", get_timId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse,transducerBlockData", get_transducerBlockData_handle());
		...
		_datamemberHandleNameMap.put(get_transducerBlockData_handle(), "transducerBlockData");
		
	}

	private static boolean _isPublished = false;
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse:  could not publish:  ";

	/**
	* Publishes the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse:  could not unpublish:  ";
	/**
	* Unpublishes the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class for a federate.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse:  could not subscribe:  ";
	/**
	* Subscribes a federate to the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMResponse:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	* (that is, the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class).
	...
	*/
	...
	public String toString() {
		return "ReadTransducerBlockDataFromAChannelOfATIMResponse("
			...
			+ "," + "ncapId:" + get_ncapId()
			+ "," + "timId:" + get_timId()
			+ "," + "transducerBlockData:" + get_transducerBlockData()
			+ ")";
	}
	...
	private String _transducerBlockData = "";
	...
	*/
	...
	/**
	* Set the value of the "transducerBlockData" parameter to "value" for this parameter.
	*
	* @param value the new value for the "transducerBlockData" parameter
	*/
	public void set_transducerBlockData( String value ) { _transducerBlockData = value; }
	
	/**
	* Returns the value of the "transducerBlockData" parameter of this interaction.
	*
	* @return the value of the "transducerBlockData" parameter
	*/
	public String get_transducerBlockData() { return _transducerBlockData; }
	


	protected ReadTransducerBlockDataFromAChannelOfATIMResponse( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected ReadTransducerBlockDataFromAChannelOfATIMResponse( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class instance
	*/
	public ReadTransducerBlockDataFromAChannelOfATIMResponse( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #ReadTransducerBlockDataFromAChannelOfATIMResponse( ReceivedInteraction datamemberMap )}, except this
	* new ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class instance
	* @param logicalTime timestamp for this new ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class
	* instance
	*/
	public ReadTransducerBlockDataFromAChannelOfATIMResponse( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class instance that is a duplicate
	* of the instance referred to by ReadTransducerBlockDataFromAChannelOfATIMResponse_var.
	*
	* @param ReadTransducerBlockDataFromAChannelOfATIMResponse_var ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class instance of which
	* this newly created ReadTransducerBlockDataFromAChannelOfATIMResponse interaction class instance will be a
	* duplicate
	*/
	public ReadTransducerBlockDataFromAChannelOfATIMResponse( ReadTransducerBlockDataFromAChannelOfATIMResponse ReadTransducerBlockDataFromAChannelOfATIMResponse_var ) {
		super( ReadTransducerBlockDataFromAChannelOfATIMResponse_var );
		
		
		set_CheckSum( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_CheckSum() );
		set_Length( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_Length() );
		set_MessageID( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_MessageID() );
		set_MessageType( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_MessageType() );
		set_Priority( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_Priority() );
		set_SequenceNo( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_SequenceNo() );
		set_SessionNo( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_SessionNo() );
		set_Status( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_Status() );
		set_channelId( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_channelId() );
		set_errorCode( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_errorCode() );
		set_ncapId( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_ncapId() );
		set_timId( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_timId() );
		set_transducerBlockData( ReadTransducerBlockDataFromAChannelOfATIMResponse_var.get_transducerBlockData() );
	}
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		else if (  "transducerBlockData".equals( datamemberName )  ) return get_transducerBlockData();
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		else if ( get_transducerBlockData_handle() == datamemberHandle ) return get_transducerBlockData();
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		else if ( param_handle == get_transducerBlockData_handle() ) set_transducerBlockData( val );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		else if (  "transducerBlockData".equals( datamemberName )  ) set_transducerBlockData( val );	
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		else if (  "transducerBlockData".equals( datamemberName )  ) set_transducerBlockData( (String)val );		
		else retval = super.setParameterAux( datamemberName, val );
	...
	protected SuppliedParameters createSuppliedDatamembers() {
		SuppliedParameters datamembers = super.createSuppliedDatamembers();
			...
			datamembers.add( get_transducerBlockData_handle(), get_transducerBlockData().getBytes() );
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof ReadTransducerBlockDataFromAChannelOfATIMResponse ) {
			ReadTransducerBlockDataFromAChannelOfATIMResponse data = (ReadTransducerBlockDataFromAChannelOfATIMResponse)object;
				...
				_timId = data._timId;
				_transducerBlockData = data._transducerBlockData;
