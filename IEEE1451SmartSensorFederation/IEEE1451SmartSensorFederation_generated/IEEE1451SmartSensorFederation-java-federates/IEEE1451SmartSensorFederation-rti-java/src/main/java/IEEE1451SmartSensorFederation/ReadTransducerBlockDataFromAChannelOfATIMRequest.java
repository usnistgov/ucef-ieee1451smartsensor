...
/**
* The ReadTransducerBlockDataFromAChannelOfATIMRequest class implements the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction in the
* IEEE1451SmartSensorFederation simulation.
*/
public class ReadTransducerBlockDataFromAChannelOfATIMRequest extends C2WInteractionRoot {

	private static final Logger logger = LogManager.getLogger(ReadTransducerBlockDataFromAChannelOfATIMRequest.class);

	/**
	* Default constructor -- creates an instance of the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction
	* class with default parameter values.
	*/
	public ReadTransducerBlockDataFromAChannelOfATIMRequest() { }
	...
	private static int _numberOfSamples_handle;
	private static int _sampleIntervalNsecs_handle;
	private static int _sampleIntervalSecs_handle;
	private static int _startTimeNsecs_handle;
	private static int _startTimeSecs_handle;
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the "numberOfSamples" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "numberOfSamples" parameter
	*/
	public static int get_numberOfSamples_handle() { return _numberOfSamples_handle; }
	
	/**
	* Returns the handle (RTI assigned) of the "sampleIntervalNsecs" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "sampleIntervalNsecs" parameter
	*/
	public static int get_sampleIntervalNsecs_handle() { return _sampleIntervalNsecs_handle; }
	
	/**
	* Returns the handle (RTI assigned) of the "sampleIntervalSecs" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "sampleIntervalSecs" parameter
	*/
	public static int get_sampleIntervalSecs_handle() { return _sampleIntervalSecs_handle; }
	
	/**
	* Returns the handle (RTI assigned) of the "startTimeNsecs" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "startTimeNsecs" parameter
	*/
	public static int get_startTimeNsecs_handle() { return _startTimeNsecs_handle; }
	
	/**
	* Returns the handle (RTI assigned) of the "startTimeSecs" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "startTimeSecs" parameter
	*/
	public static int get_startTimeSecs_handle() { return _startTimeSecs_handle; }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the ReadTransducerBlockDataFromAChannelOfATIMRequest
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class.
	*/
	public static String get_simple_class_name() { return "ReadTransducerBlockDataFromAChannelOfATIMRequest"; }
	...
	* ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest");
		_classNameClassMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest", ReadTransducerBlockDataFromAChannelOfATIMRequest.class);
		
		_datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest", _datamemberNames);
		_allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest", _allDatamemberNames);
		...
		_datamemberNames.add("numberOfSamples");
		
		_datamemberNames.add("sampleIntervalNsecs");
		_datamemberNames.add("sampleIntervalSecs");
		
		_datamemberNames.add("startTimeNsecs");
		_datamemberNames.add("startTimeSecs");
		...
		_allDatamemberNames.add("numberOfSamples");
		_allDatamemberNames.add("originFed");
		_allDatamemberNames.add("sampleIntervalNsecs");
		_allDatamemberNames.add("sampleIntervalSecs");
		_allDatamemberNames.add("sourceFed");
		_allDatamemberNames.add("startTimeNsecs");
		_allDatamemberNames.add("startTimeSecs");
		...
		_datamemberTypeMap.put("numberOfSamples", "long");
		_datamemberTypeMap.put("sampleIntervalNsecs", "long");
		_datamemberTypeMap.put("sampleIntervalSecs", "long");
		_datamemberTypeMap.put("startTimeNsecs", "long");
		_datamemberTypeMap.put("startTimeSecs", "long");
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest:  could not initialize:  ";
	protected static void init(RTIambassador rti) {
		...
		while(isNotInitialized) {
			try {
				_handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest");
		...
		_classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest", get_handle());
		_classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest");
		_classHandleSimpleNameMap.put(get_handle(), "ReadTransducerBlockDataFromAChannelOfATIMRequest");
		...
		while(isNotInitialized) {
			try {
				...
				_numberOfSamples_handle = rti.getParameterHandle("numberOfSamples", get_handle());			
				_sampleIntervalNsecs_handle = rti.getParameterHandle("sampleIntervalNsecs", get_handle());			
				_sampleIntervalSecs_handle = rti.getParameterHandle("sampleIntervalSecs", get_handle());			
				_startTimeNsecs_handle = rti.getParameterHandle("startTimeNsecs", get_handle());			
				_startTimeSecs_handle = rti.getParameterHandle("startTimeSecs", get_handle());			
		...
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,CheckSum", get_CheckSum_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,Length", get_Length_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,MessageID", get_MessageID_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,MessageType", get_MessageType_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,Priority", get_Priority_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,SequenceNo", get_SequenceNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,SessionNo", get_SessionNo_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,Status", get_Status_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,channelId", get_channelId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,ncapId", get_ncapId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,numberOfSamples", get_numberOfSamples_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,sampleIntervalNsecs", get_sampleIntervalNsecs_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,sampleIntervalSecs", get_sampleIntervalSecs_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,startTimeNsecs", get_startTimeNsecs_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,startTimeSecs", get_startTimeSecs_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,timId", get_timId_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,timeoutNsecs", get_timeoutNsecs_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest,timeoutSecs", get_timeoutSecs_handle());
		...
		_datamemberHandleNameMap.put(get_numberOfSamples_handle(), "numberOfSamples");
		_datamemberHandleNameMap.put(get_sampleIntervalNsecs_handle(), "sampleIntervalNsecs");
		_datamemberHandleNameMap.put(get_sampleIntervalSecs_handle(), "sampleIntervalSecs");
		_datamemberHandleNameMap.put(get_startTimeNsecs_handle(), "startTimeNsecs");
		_datamemberHandleNameMap.put(get_startTimeSecs_handle(), "startTimeSecs");
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest:  could not publish:  ";

	/**
	* Publishes the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest:  could not unpublish:  ";
	/**
	* Unpublishes the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class for a federate.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest:  could not subscribe:  ";
	/**
	* Subscribes a federate to the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ReadTransducerBlockDataFromAChannelOfATIMRequest:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	* (that is, the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class).
	...
	*/
	...
	public String toString() {
		return "ReadTransducerBlockDataFromAChannelOfATIMRequest("
			...
			+ "," + "ncapId:" + get_ncapId()
			+ "," + "numberOfSamples:" + get_numberOfSamples()
			+ "," + "sampleIntervalNsecs:" + get_sampleIntervalNsecs()
			+ "," + "sampleIntervalSecs:" + get_sampleIntervalSecs()
			+ "," + "startTimeNsecs:" + get_startTimeNsecs()
			+ "," + "startTimeSecs:" + get_startTimeSecs()
			+ "," + "timId:" + get_timId()
	...
	private long _sampleIntervalNsecs = 0;
	
	private long _sampleIntervalSecs = 0;
	
	private long _startTimeNsecs = 0;
	
	private long _startTimeSecs = 0;
	...
	*/
	...
	/**
	* Set the value of the "numberOfSamples" parameter to "value" for this parameter.
	*
	* @param value the new value for the "numberOfSamples" parameter
	*/
	public void set_numberOfSamples( long value ) { _numberOfSamples = value; }
	
	/**
	* Returns the value of the "numberOfSamples" parameter of this interaction.
	*
	* @return the value of the "numberOfSamples" parameter
	*/
	public long get_numberOfSamples() { return _numberOfSamples; }
	
	
	/**
	* Set the value of the "sampleIntervalNsecs" parameter to "value" for this parameter.
	*
	* @param value the new value for the "sampleIntervalNsecs" parameter
	*/
	public void set_sampleIntervalNsecs( long value ) { _sampleIntervalNsecs = value; }
	
	/**
	* Returns the value of the "sampleIntervalNsecs" parameter of this interaction.
	*
	* @return the value of the "sampleIntervalNsecs" parameter
	*/
	public long get_sampleIntervalNsecs() { return _sampleIntervalNsecs; }
	
	
	/**
	* Set the value of the "sampleIntervalSecs" parameter to "value" for this parameter.
	*
	* @param value the new value for the "sampleIntervalSecs" parameter
	*/
	public void set_sampleIntervalSecs( long value ) { _sampleIntervalSecs = value; }
	
	/**
	* Returns the value of the "sampleIntervalSecs" parameter of this interaction.
	*
	* @return the value of the "sampleIntervalSecs" parameter
	*/
	public long get_sampleIntervalSecs() { return _sampleIntervalSecs; }
	
	
	/**
	* Set the value of the "startTimeNsecs" parameter to "value" for this parameter.
	*
	* @param value the new value for the "startTimeNsecs" parameter
	*/
	public void set_startTimeNsecs( long value ) { _startTimeNsecs = value; }
	
	/**
	* Returns the value of the "startTimeNsecs" parameter of this interaction.
	*
	* @return the value of the "startTimeNsecs" parameter
	*/
	public long get_startTimeNsecs() { return _startTimeNsecs; }
	
	
	/**
	* Set the value of the "startTimeSecs" parameter to "value" for this parameter.
	*
	* @param value the new value for the "startTimeSecs" parameter
	*/
	public void set_startTimeSecs( long value ) { _startTimeSecs = value; }
	
	/**
	* Returns the value of the "startTimeSecs" parameter of this interaction.
	*
	* @return the value of the "startTimeSecs" parameter
	*/
	public long get_startTimeSecs() { return _startTimeSecs; }
	...
	*/
	...
	protected ReadTransducerBlockDataFromAChannelOfATIMRequest( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected ReadTransducerBlockDataFromAChannelOfATIMRequest( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class instance
	*/
	public ReadTransducerBlockDataFromAChannelOfATIMRequest( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #ReadTransducerBlockDataFromAChannelOfATIMRequest( ReceivedInteraction datamemberMap )}, except this
	* new ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class instance
	* @param logicalTime timestamp for this new ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class
	* instance
	*/
	public ReadTransducerBlockDataFromAChannelOfATIMRequest( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class instance that is a duplicate
	* of the instance referred to by ReadTransducerBlockDataFromAChannelOfATIMRequest_var.
	*
	* @param ReadTransducerBlockDataFromAChannelOfATIMRequest_var ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class instance of which
	* this newly created ReadTransducerBlockDataFromAChannelOfATIMRequest interaction class instance will be a
	* duplicate
	*/
	public ReadTransducerBlockDataFromAChannelOfATIMRequest( ReadTransducerBlockDataFromAChannelOfATIMRequest ReadTransducerBlockDataFromAChannelOfATIMRequest_var ) {
		super( ReadTransducerBlockDataFromAChannelOfATIMRequest_var );
		
		
		set_CheckSum( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_CheckSum() );
		set_Length( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_Length() );
		set_MessageID( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_MessageID() );
		set_MessageType( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_MessageType() );
		set_Priority( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_Priority() );
		set_SequenceNo( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_SequenceNo() );
		set_SessionNo( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_SessionNo() );
		set_Status( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_Status() );
		set_channelId( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_channelId() );
		set_ncapId( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_ncapId() );
		set_numberOfSamples( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_numberOfSamples() );
		set_sampleIntervalNsecs( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_sampleIntervalNsecs() );
		set_sampleIntervalSecs( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_sampleIntervalSecs() );
		set_startTimeNsecs( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_startTimeNsecs() );
		set_startTimeSecs( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_startTimeSecs() );
		set_timId( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_timId() );
		set_timeoutNsecs( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_timeoutNsecs() );
		set_timeoutSecs( ReadTransducerBlockDataFromAChannelOfATIMRequest_var.get_timeoutSecs() );
	}
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		else if (  "numberOfSamples".equals( datamemberName )  ) return new Long(get_numberOfSamples());
		else if (  "sampleIntervalNsecs".equals( datamemberName )  ) return new Long(get_sampleIntervalNsecs());
		else if (  "sampleIntervalSecs".equals( datamemberName )  ) return new Long(get_sampleIntervalSecs());
		else if (  "startTimeNsecs".equals( datamemberName )  ) return new Long(get_startTimeNsecs());
		else if (  "startTimeSecs".equals( datamemberName )  ) return new Long(get_startTimeSecs());
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		else if ( get_numberOfSamples_handle() == datamemberHandle ) return new Long(get_numberOfSamples());
		else if ( get_sampleIntervalNsecs_handle() == datamemberHandle ) return new Long(get_sampleIntervalNsecs());
		else if ( get_sampleIntervalSecs_handle() == datamemberHandle ) return new Long(get_sampleIntervalSecs());
		else if ( get_startTimeNsecs_handle() == datamemberHandle ) return new Long(get_startTimeNsecs());
		else if ( get_startTimeSecs_handle() == datamemberHandle ) return new Long(get_startTimeSecs());
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		else if ( param_handle == get_numberOfSamples_handle() ) set_numberOfSamples( Long.parseLong(val) );
		else if ( param_handle == get_sampleIntervalNsecs_handle() ) set_sampleIntervalNsecs( Long.parseLong(val) );
		else if ( param_handle == get_sampleIntervalSecs_handle() ) set_sampleIntervalSecs( Long.parseLong(val) );
		else if ( param_handle == get_startTimeNsecs_handle() ) set_startTimeNsecs( Long.parseLong(val) );
		else if ( param_handle == get_startTimeSecs_handle() ) set_startTimeSecs( Long.parseLong(val) );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		else if (  "numberOfSamples".equals( datamemberName )  ) set_numberOfSamples( Long.parseLong(val) );
		else if (  "sampleIntervalNsecs".equals( datamemberName )  ) set_sampleIntervalNsecs( Long.parseLong(val) );
		else if (  "sampleIntervalSecs".equals( datamemberName )  ) set_sampleIntervalSecs( Long.parseLong(val) );
		else if (  "startTimeNsecs".equals( datamemberName )  ) set_startTimeNsecs( Long.parseLong(val) );
		else if (  "startTimeSecs".equals( datamemberName )  ) set_startTimeSecs( Long.parseLong(val) );
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		else if (  "numberOfSamples".equals( datamemberName )  ) set_numberOfSamples( (Long)val );
		else if (  "sampleIntervalNsecs".equals( datamemberName )  ) set_sampleIntervalNsecs( (Long)val );
		else if (  "sampleIntervalSecs".equals( datamemberName )  ) set_sampleIntervalSecs( (Long)val );
		else if (  "startTimeNsecs".equals( datamemberName )  ) set_startTimeNsecs( (Long)val );
		else if (  "startTimeSecs".equals( datamemberName )  ) set_startTimeSecs( (Long)val );
	...
	protected SuppliedParameters createSuppliedDatamembers() {
		SuppliedParameters datamembers = super.createSuppliedDatamembers();
			...
			datamembers.add( get_numberOfSamples_handle(), Long.toString(get_numberOfSamples()).getBytes() );
		
			datamembers.add( get_sampleIntervalNsecs_handle(), Long.toString(get_sampleIntervalNsecs()).getBytes() );
		
			datamembers.add( get_sampleIntervalSecs_handle(), Long.toString(get_sampleIntervalSecs()).getBytes() );
		
			datamembers.add( get_startTimeNsecs_handle(), Long.toString(get_startTimeNsecs()).getBytes() );
		
			datamembers.add( get_startTimeSecs_handle(), Long.toString(get_startTimeSecs()).getBytes() );
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof ReadTransducerBlockDataFromAChannelOfATIMRequest ) {
			ReadTransducerBlockDataFromAChannelOfATIMRequest data = (ReadTransducerBlockDataFromAChannelOfATIMRequest)object;
				...
				_numberOfSamples = data._numberOfSamples;
				_sampleIntervalNsecs = data._sampleIntervalNsecs;
				_sampleIntervalSecs = data._sampleIntervalSecs;
				_startTimeNsecs = data._startTimeNsecs;
				_startTimeSecs = data._startTimeSecs;
				_timId = data._timId;
